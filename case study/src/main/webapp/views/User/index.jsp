                ...
                <div class="shp__cart__wrap">
                    <div class="shp__single__product">
                        <div class="shp__pro__thumb">
                            <a href="#">
                                <img src="/views/User/images/product-2/sm-smg/1.jpg" alt="product images">
                            </a>
                        </div>
                        <div class="shp__pro__details">
                            <h2><a href="/views/User/product-details.jsp">BO&Play Wireless Speaker</a></h2>
                    ...
                    <div class="shp__single__product">
                        <div class="shp__pro__thumb">
                            <a href="#">
                                <img src="/views/User/images/product-2/sm-smg/2.jpg" alt="product images">
                            </a>
                        </div>
                        <div class="shp__pro__details">
                            <h2><a href="/views/User/product-details.jsp">Brone Candle</a></h2>
                            <span class="quantity">QTY: 1</span>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="section__title--2 text-center">
                        <h2 class="title__line">Menu Product</h2>
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="/user?action=viewProduct&index=${loop.index}">
                                            <img src="${product.img}" alt="product images" width="290px" height="340px">
                                        </a>
                                    </div>
