...
<div class="wrapper">
    ...
    <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(/img/background.jpg) no-repeat scroll center center / cover ;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="checkout-method__login">
                                                    <form action="/user?action=changePassword&id_user=${iduser}" method="post">
                                                        <h5 class="checkout-method__title">Đổi mật khẩu</h5>
                                                        <p class="checkout-method__subtitle">Please enter password below:</p>
                                                        <div class="single-input">
                                                            <label for="user-pass">Password</label>
                                                            <input type="password" id="user-pass" name="password">
                                                        </div>
                                                        <c:if test="${!changepass.exit()}">
                                                            <p class="require"> *thay đổi mật khẩu thành công</p>
                                                        </c:if>
